            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                ...
                <li className="message-item">
                  <a href="#">
                    {/* <Image src="/img/messages-1.jpg" alt="" className="rounded-circle" /> */}
                    <div>
                      <h4>Maria Hudson</h4>
                ...
                <li className="message-item">
                  <a href="#">
                    {/* <Image src="assets/img/messages-2.jpg" alt="" className="rounded-circle" /> */}
                    <div>
                      <h4>Anna Nelson</h4>
                      <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                      <p>6 hrs.ago</p>
                ...
                <li className="message-item">
                  <a href="#">
                    {/* <Image src="assets/img/messages-3.jpg" alt="" className="rounded-circle" /> */}
                    <div>
                      <h4>David Muldon</h4>
                      <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                      <p>8 hrs.ago</p>
