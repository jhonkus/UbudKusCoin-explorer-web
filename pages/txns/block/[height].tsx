                          ...
                          <tbody>
                            ...
                            {transactions?.map((tx) => (
                              ...
                              <tr key={tx.Hash}>
                                ...
                                <td>
                                  <div className={styles.amountInTable}>{formatAmount(tx.Amount)} <span className="text-muted">UKC</span></div>
                                </td>
                                <td>
                                  <div className={styles.amountInTable}>{formatFee(tx.Fee)} <span className="text-muted">UKC</span></div>
                                </td>
                              </tr>
