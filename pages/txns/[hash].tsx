                ...
                <div className="card-body">
                  ...
                  {txn &&
                    ...
                    <>
                      ...
                      <div className={`row ${styles.rowDiv}`}>
                        <div className="col-sm-4">
                          <HelpTips tips={'The value being transacted in UKSC.'} />
                          Value</div>  <div className={`col-sm-8 ${styles.value}`}>{formatAmount(txn.Amount)} UKSC </div>
                      </div>

                      <div className={`row ${styles.rowDiv}`}>
                        <div className="col-sm-4">
                          <HelpTips tips={'Amount paid to the validator when processing the transaction.'} />
                          Transaction Fee</div>  <div className={`col-sm-8 ${styles.value}`}>{formatFee(txn.Fee)} UKSC </div>
                      </div>
                    </>
                  }
